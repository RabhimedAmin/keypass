...
public class ProfileAuthorities
{
	...
	public int hashCode()
	{
		...
		result = prime * result + ((grantedAuthority == null) ? 0
				: grantedAuthority.hashCode());
	...
	{
		return "ProfileAuthorities [id=" + id + ", profileName=" + name
				+ ", grantedAuthority=" + grantedAuthority + ", creationDate="
